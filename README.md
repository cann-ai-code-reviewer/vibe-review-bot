...
2026.3.10：[Anthropic宣布推出Claude Code Review](https://code.claude.com/docs/en/code-review) Code Review is billed based on token usage. Reviews average $15-25, scaling with PR size, codebase complexity, and how many issues require verification.
